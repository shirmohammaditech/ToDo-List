        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
                ...
                <div class="form-group py-4">
                        <input type="text" name="name" value="{{$todo->name }}" class="bg-gray-100 rounded border border-gray-400 leading-normal resize-none w-full h-7 py-2 px-3 font-medium placeholder-gray-700 focus:outline-none focus:bg-white">	
